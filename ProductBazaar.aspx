<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProductBazaar.aspx.vb" Inherits="ByteBazaar.ProductBazaar" %>

<!DOCTYPE html>
<html class="no-js" lang="zxx">


<!-- Mirrored from demo.Brycode.com/themes/shopgrids/ProductBazaar.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Feb 2024 12:42:02 GMT -->
<head>
    <meta charset="utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
    <title>Shop Bazaar - ByteBazaar eCommerce</title>
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    <li class="nav-item">
                                        <a href="Home.aspx" aria-label="Toggle navigation">Home</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-3">
                                            <li class="nav-item active"><a href="ProductBazaar.aspx">Shop Bazaar</a></li>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-4">
                                            ...
                                            <li class="nav-item"><a href="BlogSingleSideBar.aspx">Blog Single
                                                    Sibebar</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="breadcrumbs-content">
                        <h1 class="page-title">Shop Bazaar</h1>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                    <ul class="breadcrumb-nav">
                        <li><a href="Home.aspx"><i class="lni lni-home"></i> Home</a></li>
                ...
                <div class="col-lg-3 col-12">
                    ...
                    <div class="product-sidebar">
                        ...
                        <div class="single-widget">
                            ...
                            <ul class="list">
                                <li>
                                    <a href="ProductBazaar.aspx">Computers & Accessories </a><span>(1138)</span>
                                </li>
                                <li>
                                    <a href="ProductBazaar.aspx">Smartphones & Tablets</a><span>(2356)</span>
                                </li>
                                <li>
                                    <a href="ProductBazaar.aspx">TV, Video & Audio</a><span>(420)</span>
                                </li>
                                <li>
                                    <a href="ProductBazaar.aspx">Cameras, Photo & Video</a><span>(874)</span>
                                </li>
                                <li>
                                    <a href="ProductBazaar.aspx">Headphones</a><span>(1239)</span>
                                </li>
                                <li>
                                    <a href="ProductBazaar.aspx">Wearable Electronics</a><span>(340)</span>
                                </li>
                                <li>
                                    <a href="ProductBazaar.aspx">Printers & Ink</a><span>(512)</span>
                                </li>
                            </ul>
                        </div>
                        <!-- End Single Widget -->
                        ...
                        <div class="product-grid-topbar">
                            <div class="row align-items-center">
                                <div class="col-lg-7 col-md-8 col-12">
                                    <div class="product-sorting">    <%--fetch from the DB--%>
                            ...
                            <div class="tab-pane fade show active" id="nav-grid" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="assets/images/products/product-9.png" alt="#">
                                                <span class="sale-tag">-25%</span>
                                                <div class="button">
                                                    <a href="ProductDetails.aspx" class="btn"><i
                                                            class="lni lni-cart"></i> Add to Cart</a>
                                            ...
                                            <div class="product-info">
                                                <span class="category">Speaker</span>
                                                <h4 class="title">
                                                    <a href="ProductBazaar.aspx"> Speaker</a>
                                                </h4>
                                                <ul class="review">
                                                    <li><i class="lni lni-star-filled"></i></li>
                                                    <li><i class="lni lni-star-filled"></i></li>
            ...
            <div class="container">
                <div class="inner-content">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="copyright">
                                <p>Designed and Developed by<a href="https://Brycode.com/" rel="nofollow"
                                        target="_blank">Brycode</a></p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12">
                            <ul class="socila">

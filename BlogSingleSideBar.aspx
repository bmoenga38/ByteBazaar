<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BlogSingleSideBar.aspx.vb" Inherits="ByteBazaar.BlogSingleSideBar" %>
...
<head>
    ...
    <title>Blog Single Sidebar - ShopGrids Bootstrap 5 eCommerce HTML Template.</title>
                                ...
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-4">
                                            ...
                                            <li class="nav-item active"><a href="BlogSingleSideBar.aspx">Blog Single
                                                    Sibebar</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <div class="post-details">
                            <div class="main-content-head">
                                ...
                                <div class="meta-information">
                                    <h2 class="post-title">
                                        <a href="BlogSingle.aspx">Smartphones in Every Day Life.</a>
                                    </h2>
                                    <!-- End Meta Info -->
                                    <ul class="meta-info">
                                        <li>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <div class="single-footer f-contact">
                                ...
                                <p class="phone">Phone: (+254) 738 476 283</p>
                                <ul>
            ...
            <div class="container">
                <div class="inner-content">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="copyright">
                                <p>Designed and Developed by<a href="https://brycode.co.ke/" rel="nofollow"

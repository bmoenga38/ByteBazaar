<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="ByteBazaar.Login" %>
<!DOCTYPE html>
...
<head>
    ...
    <title>Login - ByteBazaar eCommerce.</title>
                                ...
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-2">
                                            ...
                                            <li class="nav-item active"><a href="Login.aspx">Login</a></li>
                    ...
                    <form class="card login-form" method="post">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap justify-content-between bottom-content">
                                ...
                                <a class="lost-pass" href="AccountPasswordRecovery.aspx">Forgot password?</a>
                            </div>
                            <div class="button">
                                <button class="btn" type="submit">Login</button>
                            </div>
                            <p class="outer-link">Don't have an account? <a href="Register.aspx">Register here </a>
                            </p>
                        </div>
                    </form>
                </div>
...
<!-- Mirrored from demo.ByteBazaar.com/themes/ByteBazaar/Login.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Feb 2024 12:41:52 GMT -->
</html>
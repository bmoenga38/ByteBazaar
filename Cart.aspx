<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Cart.aspx.vb" Inherits="ByteBazaar.Cart" %>
...
<head>
    ...
    <title>Cart - ByteBazaar eCommerce.</title>
                                ...
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-3">
                                            ...
                                            <li class="nav-item active"><a href="Cart.aspx">Cart</a></li>
        ...
        <div class="container">
            <div class="cart-list-head">
                ...
                <div class="cart-single-list">
                    <div class="row align-items-center">
                        <div class="col-lg-1 col-md-1 col-12">
                            <a href="ProductDetails.aspx"><img src="assets/images/cart/01.jpg" alt="#"></a>
                        </div>
                        <div class="col-lg-4 col-md-3 col-12">
                            <h5 class="product-name"><a href="ProductDetails.aspx">
                ...
                <div class="cart-single-list">
                    <div class="row align-items-center">
                        <div class="col-lg-1 col-md-1 col-12">
                            <a href="ProductDetails.aspx"><img src="assets/images/cart/02.jpg" alt="#"></a>
                        </div>
                        <div class="col-lg-4 col-md-3 col-12">
                            <h5 class="product-name"><a href="ProductDetails.aspx">
                ...
                <div class="cart-single-list">
                    <div class="row align-items-center">
                        <div class="col-lg-1 col-md-1 col-12">
                            <a href="ProductDetails.aspx"><img src="assets/images/cart/03.jpg" alt="#"></a>
                        </div>
                        <div class="col-lg-4 col-md-3 col-12">
                            <h5 class="product-name"><a href="ProductDetails.aspx">HP LaserJet Pro Laser Printer</a></h5>
                            <p class="product-des">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    ...
                                    <div class="button">
                                        ...
                                        <a href="ProductBazaar.aspx" class="btn btn-alt">Continue shopping</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from demo.ByteBazaar.com/themes/ByteBazaar/Cart.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Feb 2024 12:41:54 GMT -->
</html>
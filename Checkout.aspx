<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Checkout.aspx.vb" Inherits="ByteBazaar.Checkout" %>
...
<head>
    ...
    <title>Checkout - ByteBazaar eCommerce.</title>
                                ...
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-3">
                                            ...
                                            <li class="nav-item active"><a href="Checkout.aspx">Checkout</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                                        <a class="dd-menu collapsed" href="javascript:void(0)" data-bs-toggle="collapse"
...
<!-- Mirrored from demo.Brycode.com/themes/shopgrids/Checkout.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Feb 2024 12:42:02 GMT -->
</html>

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Contact.aspx.vb" Inherits="ByteBazaar.Contact" %>
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="Contact.aspx" class="active" aria-label="Toggle navigation">Contact
                                            Us</a>
                                    </li>
                                </ul>
                            </div> <!-- navbar collapse -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12 col-12">
                            <div class="contact-form-head">
                                <div class="form-main">
                                    <form class="form" method="post" action="https://demo.ByteBazaar.com/themes/ByteBazaar/assets/mail/mail.php">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-12">
...
<!-- Mirrored from demo.ByteBazaar.com/themes/ByteBazaar/Contact.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Feb 2024 12:41:51 GMT -->
</html>